...
class RnnDocReader(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.gru = nn.GRU(doc_hidden_size + question_hidden_size, 512 ,batch_first=True)
    ...
    def forward(self, x1, x1_f, x1_mask, x2, x2_mask):
        ...
        # pass
        #print("embeddings")
        #print(torch.sum(x1_emb.abs()))
        #print(torch.sum(x2_emb.abs()))
        ...
        #print('check rnn reader output size')
        #print(doc_hiddens[:, -1, :].size())
        #print(hiddens[0].size())
        #print(question_hidden.size())
        #print(doc_hiddens[:, -1, :].size())
        #print(hiddens[0].size())

        return doc_hiddens[:, -1, :], hiddens[0], question_hidden[:,-1,:]
