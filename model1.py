...
class MIL_AnswerTrigger(nn.Module):
    def __init__(self, args, word_embeddings):
        ...
        self.embedding.cuda()
        self.q_rnn = nn.GRU(args.emb_dim, args.hidden_size, num_layers=args.num_layers, batch_first=True, dropout=0)
        self.p_rnn = nn.GRU(args.emb_dim, args.hidden_size, num_layers=args.num_layers, batch_first=True, dropout=0)
